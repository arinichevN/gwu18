...
function build_lib {
	...
	rm -f libpac.a
	ar -crv libpac.a 1w.o app.o crc.o gpio.o timef.o $SOCK.o util.o tsv.o lcorrection.o device/ds18b20.o acp/main.o && echo "library: done" && echo "hardware: $CPU $PINOUT"
	rm -f *.o acp/*.o
}
#    1         2
#debug_mode bin_name
