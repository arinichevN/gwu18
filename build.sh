...
function for_all_debug {
	...
	cd ../ && \
	gcc -D_REENTRANT -DMODE_DEBUG -DP_ALL main.c -o bin -I/opt/PostgreSQL/9.5/include -L/opt/PostgreSQL/9.5/lib -L./lib -lpq -lpthread -lpac && \
	echo "Application $APP successfully installed. Launch command: sudo ./bin"
}
#builds application for Allwinner A20 CPU
function for_a20 {
...
function rt {
	...
	./build.sh for_a20_debug && \
	cd ../ && \
	gcc -DMODE_DEBUG -DP_A20 main_rt.c -o bin_rt  -L./lib -lpthread -lpac && \
	echo "Application $APP successfully installed. Launch command: sudo ./bin_rt"
}
